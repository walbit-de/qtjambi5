            ...
            try {
                ...
                if(vcdir == null) {
                    ...
                    if(!fileVcDir.isDirectory()) {
                        ...
                        else if(compiler == Compiler.MSVC2012_64 || compiler == Compiler.MSVC2013_64 || compiler == Compiler.MSVC2015_64 || compiler == Compiler.MSVC2019_64)
